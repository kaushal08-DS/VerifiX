...
def create_pdf_report(
    ...
    pdf.setTitle("VerifiX Fraud Report")
    ...
    pdf.drawString(
        50,
        640,
        f"Highest Fraud Probability: {highest_probability:.2%}"
    )

    pdf.drawString(
        50,
        600,
        "Generated by VerifiX Fraud Detection System"
    )
...
if uploaded_file:
    ...
    fraud_rate = (
        fraud_count / len(results_df)
    ) * 100

    highest_probability = (
        results_df["Fraud_Probability"].max()
    )
